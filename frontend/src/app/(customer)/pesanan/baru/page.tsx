...
export default function NewOrderPage() {
  ...
  const showAddress =
    metodeAntar === "DIANTAR_KURIR" || metodeJemput === "DIJEMPUT_KURIR";

  const selectedOutletData = outlets.find(
    (outlet) => outlet.id_outlet === selectedOutlet,
  );

  const subtotal = Number(selectedServiceData?.harga ?? 0) * quantity;
  ...
  const handleCreateOrder = async () => {
    ...
    try {
      const payload = {
        ...
        // Tanggal & slot penjemputan: kurir datang ke customer untuk ambil laundry
        ...
        id_slot_antar:
          metodeAntar === "DIANTAR_KURIR" ? selectedPickupSlot : null,

        // Tanggal & slot pengantaran: kurir mengembalikan laundry ke customer
        ...
        id_slot_jemput:
          metodeJemput === "DIJEMPUT_KURIR" ? selectedDeliverySlot : null,
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-4xl font-bold text-slate-800">Buat Pesanan Baru</h1>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  <Select
                    ...
                    placeholder={
                      pickupDate ? "Pilih Jam" : "Pilih tanggal terlebih dahulu"
                    }
          ...
          <div className="mt-8 grid grid-cols-2 gap-6">
            ...
            <div>
              <Select
                ...
                placeholder={
                  returnDate ? "Pilih Jam" : "Pilih tanggal terlebih dahulu"
                }
      ...
      {showAddress && (
        ...
        >
          {profile && (
            <AddressCard alamat={profile.alamat} telepon={profile.no_telepon} />
          )}
        </Section>
      )}
